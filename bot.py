...
def start(message):
	...
	'Какие возможности предлагает наша программа:\n\n'
	'- взять людей на подселение\n'
	'  Перейдите в раздел "Добавить объявление" или "Просмотреть объявления" и укажите, что Вы ищете людей для подселения\n'
	'- найти жильё для заселения \n'
	'  Перейдите в раздел "Добавить объявление" или "Просмотреть объявления" и укажите, что Вы  ищете жилье для заселения\n'
	'- поиск компаньона для совместной аренды\n\n'
	'Если у вас есть идеи по улучшению программы, будем рады услышать Ваше мнение в разделе "Обратная связь"', reply_markup=keyboard)
